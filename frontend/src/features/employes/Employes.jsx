// ================================================
// FUELO V2 — Employés avec thème dark/light
...
export default function Employes() {
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      ...
      // Les erreurs sont déjà gérées dans le hook via toast.
    }
  }
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 14, marginBottom: 16 }} className="fuelo-grid-3">
              <div>
                ...
                <input
                  ...
                  onBlur={(e) => {
                    e.target.style.borderColor = errors.nom ? theme.colors.danger : palette.cardBorder
                  }}
              ...
              <div>
                ...
                <input
                  ...
                  onBlur={(e) => {
                    e.target.style.borderColor = errors.email ? theme.colors.danger : palette.cardBorder
                  }}
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  <input
                    ...
                    onBlur={(e) => {
                      e.target.style.borderColor = errors.password ? theme.colors.danger : palette.cardBorder
                    }}
      ...
      <div style={{ background: palette.card, border: `1px solid ${palette.cardBorder}`, borderRadius: theme.radius.lg, overflow: 'hidden', boxShadow: theme.shadow.sm }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 160px 90px 100px 110px 100px', padding: '10px 22px', background: palette.hover, borderBottom: `1px solid ${palette.cardBorder}`, gap: 8 }}>
          {['Membre', 'Email', 'Rôle', 'Ventes/jour', 'Revenu/jour', 'Actions'].map((h) => (
            <div key={h} style={{ fontSize: 10, fontWeight: theme.font.weight.bold, color: palette.textMuted, textTransform: 'uppercase', letterSpacing: '0.07em' }}>
              {h}
            </div>
          ))}
        </div>
