...
// ── Contenu sidebar ───────────────────────────────────
function Content({ alertesNb, navItems, location, navigate, setMobileOpen, logout, user, role }) {
  return (
...
export default function Sidebar({ alertesNb = 0 }) {
  ...
  return (
    <>
      ...
      >
        <Content alertesNb={alertesNb} navItems={navItems} location={location} navigate={navigate} setMobileOpen={setMobileOpen} logout={logout} user={user} role={role} />
      </div>
