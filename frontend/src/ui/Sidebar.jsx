...
const ALL_NAV = [
  ...
  { path: '/profile',   label: 'Mon profil',    roles: ['owner', 'manager', 'pompiste'],  d: 'M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2M12 11a4 4 0 100-8 4 4 0 000 8z' },
...
export default function Sidebar({ alertesNb = 0 }) {
  ...
  return (
    <>
      {/* Desktop */}
      <div className="fuelo-sidebar-desktop"
      ...
      {/* Hamburger mobile */}
      <button onClick={() => setMobileOpen(!mobileOpen)} className="fuelo-hamburger"
      ...
      {/* Drawer mobile */}
      <div className="fuelo-sidebar-mobile"
